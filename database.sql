...
-- ============================================================================
-- TABLA DE USUARIOS BIOMÉTRICOS Y CONTRASEÑA / PIN
-- ============================================================================
...
-- 2. Usuario de Ejemplo para pruebas con contraseña '1234' y permisos completos
...
ON DUPLICATE KEY UPDATE nombre = VALUES(nombre), permisos = VALUES(permisos), password = VALUES(password);
